...
if (choice == "YES"):
    ...
    print("8h")
    clip_data(edges_buffer_path, shadows_08_path, shadows_08_clipped_path, 1, "ombres")
    print("13h")
    clip_data(edges_buffer_path, shadows_13_path, shadows_13_clipped_path, 1, "ombres")
    print("18h")
    clip_data(edges_buffer_path, shadows_18_path, shadows_18_clipped_path, 1, "ombres")
    ...
    #### RENAME COLUMNS ######
    ombre_8 = gpd.read_file(edges_buffer_ombres_08_prop_path)
    ombre_8 = ombre_8.rename(columns={"ombres_prop": "ombres_08_prop"})
    ombre_8.to_file(edges_buffer_ombres_08_prop_path, driver="GPKG", layer="edges")
